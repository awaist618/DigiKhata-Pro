        ...
        child: Column(
          children: [
            ...
            _buildReportCard(
              ...
              AppColors.primaryBlue,
              isDarkMode,
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const DetailedReportScreen(reportType: 'Monthly Statement'))),
            ),
            const SizedBox(height: 16),
            _buildReportCard(
              context,
              'Yearly Summary',
              'Full breakdown of the current year',
              Icons.history_toggle_off,
              AppColors.adminPrimary,
              isDarkMode,
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const DetailedReportScreen(reportType: 'Yearly Summary'))),
            ),
            const SizedBox(height: 16),
            _buildReportCard(
              context,
